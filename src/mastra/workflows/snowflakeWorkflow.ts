...
export const snowflakeWorkflow = new Workflow({
...
const queryDataStep = new Step({
    ...
    execute: async ({ context }) => {
        ...
        const agent = mastra.getAgent("snowflakeDataAgent");
        const graphDataGenerator = mastra.getAgent("graphDataGenerator");
        try {
...
const analyzeDataStep = new Step({
    ...
    execute: async ({ context }) => {
        ...
        const agent = mastra.getAgent("snowflakeAnalysisAgent");
        try {
...
export default snowflakeWorkflow;
